Merhaba, Python kullanarak tasarladığım bu projede arayüz olarak Tkinter kütüpahanesi, veri tabanı bağlantısı için Pyodbc, veri tabanı olarak SQL Server'i kullandım.
